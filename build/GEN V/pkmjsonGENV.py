...
spec = importlib.util.spec_from_file_location("pkmtypes", os.path.join(os.path.dirname(__file__), "pkmtypesGENV.py"))
...
def export_results_to_json(filename="pkm-scoreGENV.json"):
    results = []
