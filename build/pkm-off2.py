...
def handle_csv_export(data):
    try:
        ...
        export_combinations_to_csv(monotype_combinations, os.path.join(output_dir, 'monotype_combinations_offence.csv'), ['First Type', 'Defensive Score', 'Offensive Score', 'Total Score'])
        print("Monotype combinations successfully exported to monotype_combinations_offence.csv")
        export_combinations_to_csv(dualtype_combinations, os.path.join(output_dir, 'dualtype_combinations_offence.csv'), ['First Type', 'Second Type', 'Defensive Score', 'Offensive Score', 'Total Score'])
        print("Dual type combinations successfully exported to dualtype_combinations_offence.csv")
        export_combinations_to_csv(tripletype_combinations, os.path.join(output_dir, 'tripletype_combinations_offence.csv'), ['First Type', 'Second Type', 'Third Type', 'Defensive Score', 'Offensive Score', 'Total Score'])
        print("Triple type combinations successfully exported to tripletype_combinations_offence.csv")
